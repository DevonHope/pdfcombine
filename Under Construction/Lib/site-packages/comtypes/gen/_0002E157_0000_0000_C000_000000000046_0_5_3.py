# -*- coding: mbcs -*-
typelib_path = 'C:\\Program Files\\WindowsApps\\Microsoft.Office.Desktop_16051.14228.20226.0_x86__8wekyb3d8bbwe\\VFS\\ProgramFilesCommonX86\\Microsoft Shared\\VBA\\VBA6\\VBE6EXT.OLB'
...
__all__ = [ 'vbextFileTypeForm', '_Properties', '_VBProjectsEvents',
           'vbext_wt_Browser', 'vbext_ct_Document',
           'vbext_CodePaneview', 'vbext_wt_Find', '_VBComponent_Old',
           'vbext_wt_LinkedWindowFrame', '_VBComponents_Old',
           'ReferencesEvents', '_VBProject_Old', 'vbext_ProjectType',
           'vbext_pp_locked', '_dispReferences_Events',
           'vbext_WindowType', 'vbext_ws_Minimize',
           'vbext_wt_MainWindow', 'vbext_vm_Break',
           'SelectedComponents', 'vbext_ct_ClassModule', 'CodeModule',
           'vbextFileTypeUserControl', 'VBE', 'vbextFileTypeRes',
           'ProjectTemplate', 'CodePanes', '_CodePanes',
           '_dispVBComponentsEvents', '_CodePane',
           'vbextFileTypeDesigners', 'vbext_wt_CodeWindow', 'Windows',
           'vbextFileTypeFrx', 'VBComponents', '_VBComponentsEvents',
           'vbext_ct_MSForm', 'vbextFileTypeModule',
           'vbextFileTypeProject', 'Events', 'vbext_vm_Design',
           'AddIn', 'vbextFileTypeGroupProject', 'CodePane',
           '_dispReferencesEvents', 'Property', '_LinkedWindows',
           'vbext_ct_ActiveXDesigner', 'VBProjects',
           'vbext_cv_ProcedureView', 'References', 'Components',
           'Addins', 'vbext_ct_StdModule', '_Windows_old',
           'vbextFileTypeBinary', 'vbext_pt_HostProject',
           'vbext_pk_Set', 'vbext_wt_Immediate', '_Components',
           'vbext_ProjectProtection', 'vbext_pt_StandAlone',
           'vbext_pk_Proc', '_CommandBarControlEvents', 'Reference',
           'vbext_wt_PropertyWindow', 'vbext_pk_Let', '_VBComponents',
           'Properties', '_References', '_Windows', 'vbext_VBAMode',
           'Window', '_VBComponent', 'vbext_RefKind',
           'vbext_rk_Project', '_VBProjects', 'vbext_ws_Normal',
           '_AddIns', 'vbext_pk_Get', 'vbext_wt_Locals',
           'vbext_pp_none', 'vbext_ProcKind', 'CommandBarEvents',
           'vbext_wt_ProjectWindow', 'vbextFileTypePropertyPage',
           'vbext_wt_Toolbox', 'vbext_wt_ToolWindow',
           '_VBProjects_Old', 'vbextFileTypeDocObject',
           'vbextFileTypes', 'vbext_rk_TypeLib', 'vbext_vm_Run',
           'VBProject', 'vbextFileTypeExe', 'LinkedWindows',
           'Application', 'Component', '_Component',
           'vbext_ComponentType', 'vbextFileTypeClass',
           '_dispCommandBarControlEvents', 'vbext_wt_Designer',
           'vbext_wt_FindReplace', '_ProjectTemplate',
           '_ReferencesEvents', '_CodeModule', 'vbext_ws_Maximize',
           'VBComponent', 'vbext_cv_FullModuleView', '_VBProject',
           '_dispVBProjectsEvents', 'vbext_WindowState',
           'vbext_wt_Watch']
from comtypes import _check_version; _check_version('1.1.10', 1510782171.007303)
